            ...
            <nav className='py-5 px-7 flex justify-between bg-white shadow-xl' id='navbar'>
                ...
                <div className='flex items-center sm:gap-8 idk:gap-6'>
                    ...
                    <div className='' ref={profilePicRef}>
                        {admin && admin.user.profilePicture ? <img src={admin.user.profilePicture} className='rounded-full w-14 hover:cursor-pointer' onClick={() => setProfilePicClick(!profilePicClick)}/> : <FaCircleUser color='737373' className='hover:cursor-pointer' size={56} onClick={() => setProfilePicClick(!profilePicClick)}/>}
                        {profilePicClick && 
            ...
            <nav className='py-5 px-7 flex justify-between bg-white shadow-xl' id="navbar">
                <div className='flex xxxs:gap-6 xxxxs:gap-2.5'>
                    ...
                    <div className='flex items-center'>
                        ...
                        <h1 className='text-admin-nav-links font-bold text-lg hover:cursor-default'>{page === 0 && 'Links'}{page === 1 && 'Appearance'}{page === 2 && 'Analytics'} {page === 3 && 'Settings'}{windowWidth}</h1>
                ...
                <div className='flex items-center gap-8'>
                    ...
                    <div className='' ref={profilePicRef}>
                        {admin && admin.user.profilePicture ? <img src={admin.user.profilePicture} className='rounded-full w-14 hover:cursor-pointer'/> : <FaCircleUser color='737373' size={56} onClick={() => setProfilePicClick(!profilePicClick)}/>}
                        {profilePicClick && 
                        <div className='flex flex-col items-end right-10 mt-2 absolute z-10'>    
