    ...
    if (admin.links.length === 0 && !isAdding) {
        ...
        return (
            <div className="flex flex-col gap-4 mb-12">
                <button onClick={handleLinkAdd} className='flex justify-center items-center gap-1 px-max py-3 rounded-full bg-app-blue text-white font-bold text-xl'><FaPlus className='inline' size={22}/>Add Link Window width: {windowWidth}</button>
        ...
        return (
            <div className='border border-solid border-black rounded shadow-xl bg-white flex flex-col gap-5 p-5 mb-12'>
